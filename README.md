...
-----------
   ...
   JAVA 1.0   is  for  cloud computing  and  it   is    invented   in  CDollar Technology  by    wilmix  jemin  j  at  year  2014. 
Since   J2ee ,  Struts  ,Spring  ,JSF  fails   to interact  with  JDollar.  Since  Struts ,Spring  project 

size  will   not  fit  into  Wilmix  cat  server.  AND  JAVA1.0   is  the   Part  of  JITTECHSECTION-1.
